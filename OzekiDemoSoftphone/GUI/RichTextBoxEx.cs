    ...
    class RichTextBoxEx : RichTextBox
    {
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                if (LinkPattern != null)
                {
                    Regex re = new Regex(LinkPattern, RegexOptions.None);

                    MatchCollection mc = re.Matches(base.Text);

                    foreach (Match ma in mc)
                    {
                        Select(ma.Index, ma.Value.Length);
                        SetSelectionLink(true);
                        Select(ma.Index + ma.Value.Length, 0);
                    }
                }
